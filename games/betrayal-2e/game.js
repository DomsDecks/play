const betrayal_2e = {
	...
	"cards": [
		...
		},
		{
			...
			"type": "event",
			"name": "Whoops!",
			"text": "<b>You feel a body under your foot. Before you can leap away from it, you're knocked over. A giggling voice runs away from you.</b><br><br>One of the item cards (not omens) in your hand has been stolen. You may choose which one, because picking at random using dice makes this event too annoying. Discard it.<br><br>If you have no items, then take no action.<br><br><i class='material-icons'>bolt</i>",
			"hand": true,
			"discard": true,
			"deck": true,
		},
